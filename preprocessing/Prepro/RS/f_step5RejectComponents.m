function [status, EEG, rejectedComponents] = f_step5RejectComponents(pathStep4, nameStep4, onlyBlinks, eyeDetector)
%Description:
...
%INPUTS:
%pathStep4 = Path of the .set containing the ICA information
%nameStep4 = Name of the .set containing the ICA information
...
if onlyBlinks
    ...
    params.fileName = fullfile(pathStep4, nameStep4);
    params.blinkerSaveFile = fullfile(pwd, strcat(nameStep4(1:end-3), '.mat'));
