% pop_blinker_vJM() - Runs BLINKER for a single EEG dataset.
%
% Usage:
%   >>   [OUTEEG, com, blinks, blinkFits, blinkProperties, ...
%                    blinkStatistics, params] = pop_blinks_vJM(INEEG, eyeDetector, params);
%
% Inputs:
...
function [EEG, com, blinks, blinkFits, blinkProperties, blinkStatistics, ...
                                         params] = pop_blinker_vJM(EEG, eyeDetector, params)
     ...
     [blinks, params] = extractBlinksEEG_vJM(EEG, eyeDetector, params);
